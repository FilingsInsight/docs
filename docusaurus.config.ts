...
const config: Config = {
  title: 'X-FILE AI, Filings Insight',
  tagline: 'Global Disclosure Intelligence, at a Glance',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://docs.x-file.ai',
  ...
  organizationName: 'filingsinsight', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Filings Insight, Inc. Built with Docusaurus.`,
    },
    prism: {
